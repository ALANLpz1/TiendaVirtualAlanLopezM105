...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Alan Lopez M">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>RESTABLECER CONTRASEÑA</button>
          </div>
